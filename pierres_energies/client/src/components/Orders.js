  ...
  render() {
    ...
    return(
      <div>
        ...
        {this.props.isAuthenticated && !this.props.order.loading && this.state.loaded && this.props.order.oders.lenght ?
          <Container>
            <div className='row'>
              {this.props.order.orders.map((order)=>(
                <div className='col-md-12'>
                  <Card>
                    <CardBody>
                      <CardTitle tag='h4'>{order.items.lenght} items - Total cost: Rs; {order.bill}</CardTitle>
                      <div className='row'>
